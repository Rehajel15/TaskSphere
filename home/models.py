...
class Table_taskColumn(models.Model):
    ...
    table = models.ForeignKey('Table', related_name='taskColumns', on_delete=models.CASCADE) 
...
class Table_task(models.Model):
    ...
    table = models.ForeignKey('Table', related_name='tasks', on_delete=models.CASCADE) 
...
class Table(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    task_column = models.ForeignKey(Table_taskColumn, related_name='tables', on_delete=models.CASCADE)
    task = models.ForeignKey(Table_task, related_name='tables', on_delete=models.CASCADE)
    group = models.ForeignKey('Group', related_name='tables', on_delete=models.CASCADE)  
